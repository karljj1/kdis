...
class CloneTest : public ::testing::Test {
 public:
  void Test() {
    T pduIn;
    pduIn.SetExerciseID(123);
    auto clone = KDIS::PDU::clone(pduIn);
    EXPECT_EQ(pduIn, *clone);
  }
};
...
TYPED_TEST_CASE(CloneTest, PduTestTypes6);
TYPED_TEST(CloneTest, PDU_EncodeDecode6) { this->Test(); }
