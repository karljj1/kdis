...
Run the PDU_Factory2 example to see the output of this example, PDU_Factory1
...
int main() {
  try {
    ...
    //
    // 1
    // We can give it PDU data streams and it will concatenate them for us into
    // a single packet.
    ...
    // We can then use this over time if we want to keep sending the PDU
    // together.
    pduBundle.ClearPDUs();
