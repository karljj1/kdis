...
class EntityGenerator {
 ...
 public:
  ...
  static Entity_State_PDU GenerateEntity() {
    ...
    // Entity_State_PDU, When this PDU is sent most DIS applications should then
    // show a new entity
    ...
    // Location
    KFLOAT64 GeoX = 3974445.65712107, GeoY = 220612.57183252,
             GeoZ = 4966838.38051275;  // Cardiff
    ...
    // Create the PDU
    Entity_State_PDU Entity(EntID, EntForceID, EntType, EntType,
                            EntityLinearVelocity, EntityLocation, EulerAngles(),
                            EntEA, DRP, EntMarking, EntEC);
  ...
  //************************************
  // FullName:    GenerateEntity
  // Description: Creates a random Entity_State_PDU and returns it as a ref
  // pointer.
  //************************************
  static PduPtr GenerateEntityRef() {
    ...
    // Create the PDU
    PduPtr pEntity(new Entity_State_PDU(
        EntID, EntForceID, EntType, EntType, EntityLinearVelocity,
